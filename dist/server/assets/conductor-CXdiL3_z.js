...
import { c as cn, B as Button, M as Markdown } from './router-Bxwn-W7k.js'
...
function AgentAvatar({ index, color, size = 40, className }) {
  ...
  const bodyParts = /* @__PURE__ */ jsxs(Fragment, {
    children: [
      baseParts.head,
      /* @__PURE__ */ jsx('rect', {
        x: baseParts.body.x,
...
function DeskSVG({ x, y, occupied, accent, monitorText, monitorGlow }) {
        ...
        children: [
          ...
          session.startedAt
            ? /* @__PURE__ */ jsx('span', {
                ...
                children: formatRuntime(session.startedAt, session.tokenCount),
              })
            : null,
        ],
      }),
    ...
    children: [
                  ...
                  /* @__PURE__ */ jsxs('div', {
                    ...
                    children: [
                      /* @__PURE__ */ jsxs('span', {
                        ...
                        children: [agentRows.length, ' agents'],
                      }),
                      /* @__PURE__ */ jsxs('span', {
                        className:
                      ...
                      /* @__PURE__ */ jsxs('span', {
                        ...
                        children: [sessionCount, ' sessions'],
                      }),
                    ],
                  }),
                ],
      ...
      /* @__PURE__ */ jsx('div', {
        ...
        children: /* @__PURE__ */ jsx('div', {
          className: 'space-y-2',
          children: agentRows.map((agent, index) => {
            const accent =
                  ...
                  /* @__PURE__ */ jsxs('div', {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsx('p', {
                        ...
                        children: getOfficeModelLabel(agent.modelId),
                      }),
                    ],
                  }),
                  /* @__PURE__ */ jsx('span', {
          ...
          children: [
            ...
            layoutPickerOpen &&
              /* @__PURE__ */ jsx('div', {
                ...
                children: LAYOUT_TEMPLATE_OPTIONS.map((opt) =>
                  /* @__PURE__ */ jsx(
                    'button',
                    {
                      type: 'button',
          ...
          /* @__PURE__ */ jsxs('svg', {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx('text', {
                ...
                fontWeight: '600',
                className: 'uppercase',
                children: socialLabelPosition.text,
              }),
              ...
              /* @__PURE__ */ jsxs('button', {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx('span', {
                    ...
                    children: remoteCollapsed ? 'Show' : 'Hide',
                  }),
                ],
              }),
              !remoteCollapsed
                ? /* @__PURE__ */ jsx('div', {
                    ...
                    children: remoteSessions.map((session) =>
                      /* @__PURE__ */ jsx(
                        RemoteSessionCard,
                        {
                          session,
...
function loadPersistedMission() {
  try {
    ...
    const workerKeys = Array.isArray(parsed.workerKeys)
      ? parsed.workerKeys.filter((value) => typeof value === 'string')
      : null
    const workerLabels = Array.isArray(parsed.workerLabels)
      ? parsed.workerLabels.filter((value) => typeof value === 'string')
      : null
    const workerOutputs =
    ...
    const missionStartedAt =
      parsed.missionStartedAt === null || parsed.missionStartedAt === void 0
        ? null
    ...
    const pauseStartedAt =
      parsed.pauseStartedAt === null || parsed.pauseStartedAt === void 0
        ? null
        : toIso(parsed.pauseStartedAt)
    const completedAt =
      parsed.completedAt === null || parsed.completedAt === void 0
        ? null
      ...
      ? parsed.tasks
          .map((task) => {
            ...
            return {
              ...
              status,
              workerKey:
                record.workerKey === null || record.workerKey === void 0
                  ? null
                  : readString(record.workerKey),
              output:
                record.output === null || record.output === void 0
                  ? null
    ...
    return parsed
      ...
      .map((entry) => {
        const projectPath =
          ...
          extractProjectPath$1(
            typeof entry.projectPath === 'string' ? entry.projectPath : '',
          ) ||
          null
        const outputText =
          typeof entry.outputText === 'string' ? entry.outputText : void 0
        const streamText =
          typeof entry.streamText === 'string' ? entry.streamText : void 0
        const outputPath =
          ...
          projectPath ||
          extractProjectPath$1(outputText ?? '') ||
          extractProjectPath$1(streamText ?? '') ||
          null
        return {
          ...entry,
          projectPath,
  ...
  const workerSections = workers
    .map((worker) => {
      const output = (
        ...
        getLastAssistantMessage$1(worker.raw.messages)
      ).trim()
...
function useConductorGateway() {
  ...
  const [missionWorkerKeys, setMissionWorkerKeys] = useState(
    () => new Set(initialMission?.workerKeys ?? []),
  )
  const [missionWorkerLabels, setMissionWorkerLabels] = useState(
  ...
  const [conductorSettings, setConductorSettings] = useState(() =>
  ...
  useEffect(() => {
    ...
    const shouldCompleteImmediately =
      doneRef.current && workersLookComplete(workers, 8e3)
    if (shouldCompleteImmediately) {
      setPhase('complete')
      setCompletedAt(
        (value) => value ?? /* @__PURE__ */ new Date().toISOString(),
      )
      return
    }
                  ...
                  /* @__PURE__ */ jsxs('div', {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsx('p', {
                        className:
                          'mt-2 text-2xl font-semibold text-[var(--theme-text)]',
                        children: formatUsd(estimatedCost),
                      }),
                    ],
                  }),
                ],
                            ...
                            'div',
                            {
                              ...
                              children: [
                                ...
                                /* @__PURE__ */ jsx('span', {
                                  ...
                                  children: formatUsd(
                                    estimateTokenCost(worker.totalTokens),
                                  ),
                                }),
                              ],
                            },
...
function PlanningIndicator() {
  return /* @__PURE__ */ jsx(CyclingStatus, {
            ...
            /* @__PURE__ */ jsxs('div', {
              ...
              children: [
                /* @__PURE__ */ jsxs('div', {
                  ...
                  children: [
                    /* @__PURE__ */ jsx('span', {
                      className: cn('size-2.5 rounded-full', dot.dotClass),
                    }),
                    /* @__PURE__ */ jsxs('p', {
                      className:
            ...
            /* @__PURE__ */ jsxs('div', {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx('p', {
                  ...
                  children: getShortModelName(worker.model),
                }),
              ],
            }),
            /* @__PURE__ */ jsxs('div', {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx('p', {
                  ...
                  children: worker.tokenUsageLabel,
                }),
              ],
            }),
            /* @__PURE__ */ jsxs('div', {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx('p', {
                  className: 'mt-1 text-[var(--theme-text)]',
                  children: formatElapsedTime(workerStartedAt, workerEndTime),
                }),
              ],
            }),
            /* @__PURE__ */ jsxs('div', {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx('p', {
                  className: 'mt-1 text-[var(--theme-text)]',
                  children: formatRelativeTime(worker.updatedAt, now),
                }),
              ],
            }),
          ],
...
function usePreviewAvailability(previewUrl, enabled) {
  ...
  const probeQuery = useQuery({
    ...
    refetchInterval: (query) =>
      query.state.data === true || exhausted ? false : 1500,
    staleTime: 5e3,
  })
  useEffect(() => {
    if (
              ...
              /* @__PURE__ */ jsx('span', {
                ...
                children: /* @__PURE__ */ jsxs('span', {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx('span', {
                      className: 'truncate',
                      children: getModelDisplayName(selectedModel, value),
                    }),
                  ],
                }),
              }),
...
function Conductor() {
  ...
  const handleContinueMission = async () => {
    ...
    const continuationSummarySource =
      ...
      conductor.workers
        .map((worker) => getLastAssistantMessage(worker.raw.messages))
                    ...
                    /* @__PURE__ */ jsxs('div', {
                      children: [
                        ...
                        /* @__PURE__ */ jsx('h1', {
                          ...
                          children: selectedHistoryEntry.goal,
                        }),
                        /* @__PURE__ */ jsxs('p', {
                          ...
                          /* @__PURE__ */ jsxs('div', {
                            children: [
                              ...
                              /* @__PURE__ */ jsx('p', {
                                ...
                                children: selectedHistoryOutputLabel,
                              }),
                            ],
                          }),
                          /* @__PURE__ */ jsx('a', {
                ...
                children: [
                  ...
                  historyWorkerDetails.length > 0 &&
                    /* @__PURE__ */ jsx('div', {
                      ...
                      children: historyWorkerDetails.map((worker, index) =>
                        /* @__PURE__ */ jsxs(
                          'div',
                          {
                            className:
                  ...
                  (selectedHistoryEntry.totalTokens > 0 ||
                    ...
                    /* @__PURE__ */ jsx('div', {
                      className: 'mt-4',
                      children: /* @__PURE__ */ jsx(MissionCostSection, {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsx('div', {
                          ...
                          children: /* @__PURE__ */ jsx(Markdown, {
                            className:
                              'max-h-[400px] max-w-none overflow-auto text-sm text-[var(--theme-text)]',
                            children: selectedHistoryEntry.streamText,
                          }),
                        }),
                      ],
                    }),
          ...
          /* @__PURE__ */ jsxs('div', {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx('section', {
                ...
                children: /* @__PURE__ */ jsx(OfficeView, {
              ...
              hasMissionHistory || conductor.recentSessions.length > 0
                ? /* @__PURE__ */ jsxs('section', {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsx('div', {
                        className: 'flex items-center gap-1',
                        children: ['all', 'completed', 'failed'].map((filter) =>
                          /* @__PURE__ */ jsx(
                            'button',
                            {
                              type: 'button',
                            ...
                            children: hasMissionHistory
                              ? visibleActivityItems.map((item) => {
                                  ...
                                  return /* @__PURE__ */ jsxs(
                                    'button',
                                    {
                                      type: 'button',
                                      onClick: () =>
                                        conductor.setSelectedHistoryEntry(
                                          entry,
                                        ),
                                      className:
                              ...
                              : visibleActivityItems.map((item) => {
                                  ...
                                  const displayName = label
                                    ...
                                    .replace(/[-_]+/g, ' ')
                                  const tokens =
                                    typeof recentSession.totalTokens ===
                                    'number'
                                      ? recentSession.totalTokens
                                      : 0
                                  const model = getShortModelName(
                                    recentSession.model,
                                  )
                                  const updatedAt =
                                    typeof recentSession.updatedAt === 'string'
                                      ? recentSession.updatedAt
                                      : typeof recentSession.startedAt ===
                                          'string'
                                        ? recentSession.startedAt
                                        : typeof recentSession.createdAt ===
                                            'string'
              ...
              children: /* @__PURE__ */ jsxs('div', {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxs('div', {
                    ...
                    children: [
                      /* @__PURE__ */ jsx(ModelSelectorDropdown, {
                          ...
                          /* @__PURE__ */ jsxs('div', {
                            ...
                            children: [
                              /* @__PURE__ */ jsx('input', {
                                ...
                                onChange: (event) =>
                                  updateSettings({
                                    projectsDir: event.target.value,
                                  }),
                      ...
                      /* @__PURE__ */ jsxs('label', {
                        ...
                        children: [
                          /* @__PURE__ */ jsx('input', {
                            ...
                            onChange: (event) =>
                              updateSettings({
                                supervised: event.target.checked,
                              }),
                            className:
                      ...
                      children: [
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsx('div', {
                              ...
                              children: /* @__PURE__ */ jsx('div', {
                                ...
                                children: directoryBreadcrumbs.map(
                                  (crumb, index) =>
                                    /* @__PURE__ */ jsxs(
                                      'div',
                                      {
                        ...
                        directoryBrowserError
                          ? /* @__PURE__ */ jsx('div', {
                              ...
                              children: directoryBrowserError,
                            })
                          : null,
                        /* @__PURE__ */ jsxs('div', {
                          className:
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsx('div', {
                              ...
                              children: directoryBrowserLoading
                                ? /* @__PURE__ */ jsxs('div', {
                                    className:
                                ...
                                : directoryBrowserEntries.length > 0
                                  ? /* @__PURE__ */ jsx('div', {
                                      className: 'space-y-1',
                                      children: directoryBrowserEntries.map(
                                        (entry) =>
                                          /* @__PURE__ */ jsxs(
                                            'button',
                                            {
                        ...
                        /* @__PURE__ */ jsxs('div', {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsx('div', {
                              ...
                              children: getDirectorySuggestions().map(
                                (pathOption) =>
                                  /* @__PURE__ */ jsx(
                                    'button',
                                    {
                                      type: 'button',
                                      onClick: () =>
                                        setDirectoryBrowserPath(pathOption),
                                      className:
                        ...
                        /* @__PURE__ */ jsxs('div', {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsx('button', {
                              ...
                              onClick: () => {
                                updateSettings({
                                  projectsDir: directoryBrowserPath,
                                })
              ...
              children: [
                    ...
                    ? /* @__PURE__ */ jsxs('div', {
                        ...
                        children: [
                          /* @__PURE__ */ jsx(Markdown, {
                            ...
                            children: conductor.planText.replace(
                              /(.{20,}?)\1+/g,
                              '$1',
                            ),
                          }),
                ...
                conductor.streamError &&
                  /* @__PURE__ */ jsx('div', {
                    ...
                    children: conductor.streamError,
                  }),
                        ...
                        children: /* @__PURE__ */ jsxs('div', {
                          children: [
                            ...
                            /* @__PURE__ */ jsx('p', {
                              className:
                                'mt-1 text-xs text-[var(--theme-muted-2)]',
                              children: completePhaseProjectPath
                ...
                /* @__PURE__ */ jsxs('section', {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx('div', {
                      ...
                      children: completedTaskOutputs.map((task) =>
                        /* @__PURE__ */ jsxs(
                          'div',
                          {
                            className:
              ...
              /* @__PURE__ */ jsxs('section', {
                ...
                children: [
                  ...
                  conductor.workers.length > 0 &&
                    /* @__PURE__ */ jsx('div', {
                      className: 'mt-4 space-y-2',
                      children: conductor.workers.map((worker, index) => {
                        const persona = getAgentPersona(index)
                          ...
                          'div',
                          {
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ jsxs('span', {
                                className:
                                  'font-medium text-[var(--theme-text)]',
                                children: [persona.emoji, ' ', persona.name],
                              }),
                              /* @__PURE__ */ jsx('span', {
                                className: 'text-[var(--theme-muted)]',
                                children: worker.label,
                      ...
                      ? /* @__PURE__ */ jsxs('div', {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsx('p', {
                              ...
                              children: continuationModalPreview,
                            }),
                          ],
                        })
                      : null,
                    /* @__PURE__ */ jsxs('form', {
                      ...
                      children: [
                        /* @__PURE__ */ jsx('input', {
                          ...
                          value: continueDraft,
                          onChange: (event) =>
                            setContinueDraft(event.target.value),
                          placeholder:
              ...
              /* @__PURE__ */ jsxs('div', {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxs('div', {
                    ...
                    children: [
                      /* @__PURE__ */ jsx('span', {
                        children: formatElapsedMilliseconds(
                          conductor.isPaused
                      ...
                      /* @__PURE__ */ jsxs('span', {
                        children: [activeWorkerCount, ' active'],
                      }),
                    ],
                  }),
                  conductor.isPaused
