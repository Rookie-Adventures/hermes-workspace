                      ...
                      /* @__PURE__ */ jsxs('section', {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsx('div', {
                            ...
                            children: SCHEDULE_PRESETS$1.map((preset) => {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxs('div', {
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ jsx('div', {
                                className: 'flex flex-wrap gap-2',
                                children: DELIVERY_OPTIONS$1.map((option) => {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxs('section', {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsx('div', {
                              className: 'flex flex-wrap gap-2',
                              children: SCHEDULE_PRESETS.map((preset) => {
                                const isActive = form.schedule === preset.value
                                return /* @__PURE__ */ jsx(
                                  'button',
                                  {
...
function JobCard({ job, onPause, onResume, onTrigger, onDelete, onEdit }) {
          ...
          /* @__PURE__ */ jsxs('div', {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs('div', {
                ...
                children: [
                  /* @__PURE__ */ jsx('span', {
                    children: job.schedule_display || 'custom',
                  }),
                  /* @__PURE__ */ jsx('span', { children: '·' }),
                  /* @__PURE__ */ jsxs('span', {
                    children: ['Next: ', formatNextRun(job.next_run_at)],
                  }),
                  /* @__PURE__ */ jsx('span', { children: '·' }),
                  /* @__PURE__ */ jsxs('span', {
                    children: ['Last: ', formatRunTimestamp(job.last_run_at)],
                  }),
                  job.skills &&
                    job.skills.length > 0 &&
                  ...
                  outputQuery.isLoading
                    ...
                    : outputQuery.isError
                      ...
                      : outputQuery.data && outputQuery.data.length > 0
                        ? /* @__PURE__ */ jsx('div', {
                            className: 'space-y-2',
                            children: outputQuery.data.map((output) =>
                              /* @__PURE__ */ jsxs(
                                'div',
                                {
                                  className:
  ...
  return /* @__PURE__ */ jsx('div', {
    ...
    children: /* @__PURE__ */ jsxs('div', {
      ...
      children: [
                ...
                children: [
                  ...
                  jobsQuery.data &&
                    /* @__PURE__ */ jsxs('span', {
                      ...
                      children: ['(', jobsQuery.data.length, ')'],
                    }),
                ],
              }),
              /* @__PURE__ */ jsxs('div', {
        ...
        /* @__PURE__ */ jsx(CreateJobDialog, {
          open: showCreate,
          onOpenChange: setShowCreate,
          onSubmit: handleCreate,
          isSubmitting: createMutation.isPending,
        }),
        /* @__PURE__ */ jsx(EditJobDialog, {
          job: editingJob,
