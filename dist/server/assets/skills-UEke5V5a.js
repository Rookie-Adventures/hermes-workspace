...
import {
  ...
  l as Switch,
  t as toast,
  w as writeTextToClipboard,
  m as useFeatureAvailable,
  n as BackendUnavailableState,
            ...
            children: /* @__PURE__ */ jsxs(Tabs, {
              ...
              children: [
                ...
                actionError
                  ...
                  : null,
                /* @__PURE__ */ jsx(TabsPanel, {
                  value: 'installed',
                  className: 'pt-2',
                  children: /* @__PURE__ */ jsx(SkillsGrid, {
                    skills,
                    ...
                    onInstall: (skillId) =>
                      runSkillAction('install', { skillId }),
                    onUninstall: (skillId) =>
                  ...
                  /* @__PURE__ */ jsxs('div', {
                    ...
                    children: [
                      /* @__PURE__ */ jsxs(DialogTitle, {
                        ...
                        children: [selectedSkill.icon, ' ', selectedSkill.name],
                      }),
                      ...
                      selectedSkill.security &&
                        /* @__PURE__ */ jsx('div', {
                          ...
                          children: /* @__PURE__ */ jsx(SecurityBadge, {
                      ...
                      /* @__PURE__ */ jsxs('p', {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsx('code', {
                            ...
                            children: selectedSkill.sourcePath,
                          }),
                        ],
                      }),
                      /* @__PURE__ */ jsxs('div', {
...
function SecurityBadge({ security, compact = true }) {
          ...
          children: [
            ...
            showDetails &&
              /* @__PURE__ */ jsx('div', {
                ...
                children: security.flags.map((flag) =>
                  /* @__PURE__ */ jsxs(
                    'div',
                    {
...
function SkillsGrid({
  ...
  if (loading) {
    return /* @__PURE__ */ jsx(SkillsSkeleton, {
      count: tab === 'installed' ? 6 : 9,
    })
  }
  if (skills.length === 0) {
    return /* @__PURE__ */ jsxs('div', {
      ...
      children: [
        /* @__PURE__ */ jsx('p', {
          ...
          children: emptyState?.title || 'No skills found',
        }),
        /* @__PURE__ */ jsx('p', {
          className:
                ...
                children: [
                  /* @__PURE__ */ jsxs('div', {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxs('p', {
                        className: 'line-clamp-1 text-xs text-primary-500',
                        children: ['by ', skill.author],
                      }),
                    ],
                  }),
                  /* @__PURE__ */ jsx('span', {
...
function SkillsSkeleton({ count, large = false }) {
  return /* @__PURE__ */ jsx('div', {
    className: cn(
      'grid gap-3',
      large
      ...
      /* @__PURE__ */ jsxs(
        'div',
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx('div', {
              className: 'h-4 w-1/2 rounded-md bg-primary-100',
            }),
            /* @__PURE__ */ jsx('div', {
...
function SkillsRoute() {
  ...
  if (!useFeatureAvailable('skills')) {
    return /* @__PURE__ */ jsx(BackendUnavailableState, {
      feature: 'Skills',
...
export { SkillsRoute as component }
