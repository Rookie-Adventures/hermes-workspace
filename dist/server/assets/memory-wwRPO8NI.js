...
import { m as useFeatureAvailable, T as Tabs, f as TabsList, g as TabsTab, h as TabsPanel, n as BackendUnavailableState, o as getUnavailableReason } from "./router-COrtOO2b.js";
...
const MemoryBrowserScreen = lazy(async () => {
  const module = await import("./memory-browser-screen-1v5ic2jd.js");
  return {
    default: module.MemoryBrowserScreen
  };
});
const KnowledgeBrowserScreen = lazy(async () => {
  const module = await import("./knowledge-browser-screen-o0IBbY2w.js");
  return {
