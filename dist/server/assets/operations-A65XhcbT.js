...
import {
  f as fetchSessionHistory,
  s as sendToSession,
  a as fetchModels,
  b as fetchSessions,
} from './gateway-api-D3EA1k_S.js'
...
function OrchestratorCard({ totalAgents }) {
          ...
          /* @__PURE__ */ jsxs('div', {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs('div', {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx('div', {
                    ...
                    children: /* @__PURE__ */ jsx(PixelAvatar, {
                      size: 44,
                      color: '#f59e0b',
                      accentColor: '#fbbf24',
                      status: 'running',
              ...
              /* @__PURE__ */ jsxs('p', {
                ...
                children: ['Orchestrator · ', totalAgents, ' agents reporting'],
              }),
            ],
          }),
          /* @__PURE__ */ jsx('div', {
      ...
      /* @__PURE__ */ jsx('div', {
        ...
        children:
          renderedMessages.length > 0
            ? /* @__PURE__ */ jsx('div', {
                className: 'space-y-2',
                children: renderedMessages.map((message) => {
...
function OperationsAgentCard({ agent, onOpenSettings }) {
  const queryClient = useQueryClient()
  ...
  return /* @__PURE__ */ jsxs('article', {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs('div', {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx('p', {
            ...
            children: agent.meta.description || 'No description',
          }),
          /* @__PURE__ */ jsx('p', {
            className:
      ...
      /* @__PURE__ */ jsx('div', {
        ...
        children: /* @__PURE__ */ jsx(OperationsInlineChat, {
...
function ModelSelector$2({ value, onChange, models }) {
                ...
                /* @__PURE__ */ jsxs('div', {
                  children: [
                    ...
                    /* @__PURE__ */ jsx('p', {
                      ...
                      children: 'Update this agent without leaving the roster.',
                    }),
                  ],
                }),
              ],
...
function ModelSelector$1({ value, onChange, models }) {
  const [open, setOpen] = useState(false)
  const containerRef = useRef(null)
  useEffect(() => {
    if (!open) return
        ...
        /* @__PURE__ */ jsxs('div', {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx('div', {
              ...
              children: PRESET_OPTIONS.map((preset) =>
                /* @__PURE__ */ jsxs(
                  'button',
                  {
                    type: 'button',
...
function OperationsSettingsModal({ open, settings, onClose, onSave }) {
              ...
              children: [
                /* @__PURE__ */ jsxs('span', {
                  children: [
                    ...
                    /* @__PURE__ */ jsx('span', {
                      className: 'block text-sm text-[var(--theme-muted-2)]',
...
function FilterPill({ active, label, emoji, onClick }) {
              ...
              /* @__PURE__ */ jsxs('div', {
                ...
                children: [
                  /* @__PURE__ */ jsx('span', {
                    ...
                    children: output.agentEmoji,
                  }),
                  /* @__PURE__ */ jsx('h3', {
                    className: 'text-base font-semibold',
                    children: output.agentName,
                  }),
                ],
              }),
              /* @__PURE__ */ jsx('p', {
                className: 'mt-1 text-xs text-[var(--theme-muted)]',
                children: output.jobName,
              }),
            ],
          }),
          /* @__PURE__ */ jsxs('div', {
            ...
            children: [
              ...
              duration
                ? /* @__PURE__ */ jsxs('span', { children: ['· ', duration] })
                : null,
            ],
          }),
        ],
              ...
              output.model || output.sessionKey || output.chatSessionKey
                ? /* @__PURE__ */ jsxs('div', {
                    ...
                    children: [
                      output.model
                        ? /* @__PURE__ */ jsxs('span', {
                            children: ['Model: ', output.model],
                          })
                        : null,
                      output.sessionKey
                        ? /* @__PURE__ */ jsxs('span', {
                            children: ['Session: ', output.sessionKey],
                          })
                        : null,
                      output.chatSessionKey &&
                      output.chatSessionKey !== output.sessionKey
                        ? /* @__PURE__ */ jsxs('span', {
                            children: ['Chat: ', output.chatSessionKey],
                          })
                        : null,
                    ],
                  })
          ...
          output.agentId === 'trader'
            ? /* @__PURE__ */ jsx(Button, {
                ...
                className:
                  'border border-[var(--theme-border)] bg-[var(--theme-card)] text-[var(--theme-text)] hover:bg-[var(--theme-card2)]',
                onClick: () =>
                  toast('Signals view coming soon', { type: 'info' }),
      ...
      /* @__PURE__ */ jsx('div', {
        ...
        children: /* @__PURE__ */ jsxs('div', {
          ...
          children: [
            /* @__PURE__ */ jsx('div', {
              className: 'flex flex-wrap gap-2',
              children: availableFilters.map((item) =>
                /* @__PURE__ */ jsx(
                  FilterPill,
                  {
            ...
            : /* @__PURE__ */ jsx(AnimatePresence, {
                ...
                children: /* @__PURE__ */ jsx('div', {
                  ...
                  children: outputs.map((output) =>
                    /* @__PURE__ */ jsx(OutputCard, { output }, output.id),
                  ),
                }),
              }),
      }),
...
function useOperations() {
  ...
  const agents = useMemo(() => {
    ...
    const HIDDEN_AGENTS = /* @__PURE__ */ new Set([
      'main',
      'pc1-coder',
      'pc1-planner',
      'pc1-critic',
...
function OperationsScreen() {
  ...
  return /* @__PURE__ */ jsxs('main', {
    ...
    children: [
                ...
                : /* @__PURE__ */ jsxs(Fragment, {
                    children: [
                      /* @__PURE__ */ jsx(motion.div, {
                        ...
                        children: /* @__PURE__ */ jsx(OrchestratorCard, {
      ...
      /* @__PURE__ */ jsx(OperationsNewAgentModal, {
        open: newAgentOpen,
        defaultModel,
      ...
      /* @__PURE__ */ jsx(OperationsSettingsModal, {
        open: settingsOpen,
        settings,
        onClose: () => setSettingsOpen(false),
        onSave: saveSettings,
      }),
      /* @__PURE__ */ jsx(OperationsAgentDetail, {
