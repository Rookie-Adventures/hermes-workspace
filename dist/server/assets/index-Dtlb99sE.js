...
import { p as useSettings, y as useLocale, c as cn, l as Switch, L as LOCALE_LABELS, z as setLocale, A as getTheme, C as THEMES, E as useChatSettingsStore, I as Input, B as Button, G as setTheme, H as isDarkTheme } from "./router-COrtOO2b.js";
...
function HermesConfigSection({
  ...
  const renderHermesOverview = () => /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(SettingsSection, { title: "About", description: "Hermes Agent runtime information.", icon: Notification03Icon, children: [
      /* @__PURE__ */ jsx(SettingsRow, { label: "Config location", description: "Where the agent stores its configuration.", children: /* @__PURE__ */ jsx("span", { className: "text-xs font-mono", style: {
        color: "var(--theme-muted)"
