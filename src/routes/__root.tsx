      ...
      <body>
        <script
          ...
          (function(){
            ...
            d.innerHTML = '<img src="/munragirl.png" alt="munr" style="width:96px;height:96px;margin-bottom:20px;border-radius:50%;object-fit:cover;filter:drop-shadow(0 8px 32px color-mix(in srgb,'+accent+' 45%, transparent))" />'
              + '<div style="font:700 36px/1.2 system-ui,-apple-system,sans-serif;letter-spacing:0.06em;color:'+txt+';text-shadow:0 2px 20px color-mix(in srgb,'+accent+' 35%, transparent),0 0 60px color-mix(in srgb,'+accent+' 15%, transparent);margin-bottom:4px">munr</div>'
