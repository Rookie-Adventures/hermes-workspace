...
import { c as cn, t as toast } from './router-Bxwn-W7k.js'
...
function MemoryBrowserScreen() {
  ...
  const searchQuery = useQuery({
    ...
    queryFn: () =>
      readJson(`/api/memory/search?q=${encodeURIComponent(searchTerm)}`),
              ...
              /* @__PURE__ */ jsxs('button', {
                ...
                children: [
                  /* @__PURE__ */ jsxs('span', {
                    ...
                    children: ['Memory Files (', fileItems.length, ')'],
                  }),
                  /* @__PURE__ */ jsx('span', {
                    className:
                  ...
                  /* @__PURE__ */ jsxs('div', {
                    ...
                    children: [
                      /* @__PURE__ */ jsx('div', {
                        ...
                        children: selectedPath || 'Select a file',
                      }),
                      selectedPath
                        ? /* @__PURE__ */ jsx('div', {
                            className:
              ...
              /* @__PURE__ */ jsx('div', {
                ...
                children: filesQuery.isLoading
                  ? /* @__PURE__ */ jsx(StateBox, {
                      label: 'Loading memory files...',
                    })
                  : filesQuery.error instanceof Error
                    ? /* @__PURE__ */ jsx(StateBox, {
                        label: filesQuery.error.message,
                        error: true,
                      })
                    : !selectedPath
                      ? /* @__PURE__ */ jsx(StateBox, {
                          label: 'No memory files found',
                        })
                      : contentQuery.isLoading
                        ...
                        : contentQuery.error instanceof Error
                          ? /* @__PURE__ */ jsx(StateBox, {
                              label: contentQuery.error.message,
                              error: true,
                            })
                          : isEditing
                            ? /* @__PURE__ */ jsx('div', {
