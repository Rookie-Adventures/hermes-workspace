...
import { m as useFeatureAvailable, T as Tabs, f as TabsList, g as TabsTab, h as TabsPanel, n as BackendUnavailableState, o as getUnavailableReason } from "./router-Cc1BRqzF.js";
...
const MemoryBrowserScreen = lazy(async () => {
  const module = await import("./memory-browser-screen-DSHprvlq.js");
  return {
    default: module.MemoryBrowserScreen
  };
});
const KnowledgeBrowserScreen = lazy(async () => {
  const module = await import("./knowledge-browser-screen-fa0JQL4o.js");
  return {
