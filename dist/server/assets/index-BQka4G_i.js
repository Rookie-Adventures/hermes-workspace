...
import 'yaml'
import 'node:util'
function PageThemeSwatch({ colors }) {
    ...
    children: THEMES.map((t) => {
      ...
      return /* @__PURE__ */ jsxs(
        'button',
        {
          ...
          children: [
            /* @__PURE__ */ jsx(PageThemeSwatch, {
              colors: THEME_PREVIEWS[t.id],
            }),
            /* @__PURE__ */ jsxs('div', {
          ...
          /* @__PURE__ */ jsxs('div', {
            ...
            children: [
              activeSection === 'hermes' &&
                /* @__PURE__ */ jsx(HermesConfigSection, {
                  activeView: 'hermes',
                }),
              activeSection === 'agent' &&
                /* @__PURE__ */ jsx(HermesConfigSection, {
              ...
              activeSection === 'appearance' &&
                /* @__PURE__ */ jsx(Fragment, {
                  children: /* @__PURE__ */ jsx(SettingsSection, {
                    title: 'Appearance',
                    description: 'Choose a workspace theme and accent color.',
                    icon: PaintBoardIcon,
                    children: /* @__PURE__ */ jsx(SettingsRow, {
                      label: 'Theme',
                      description:
                        'Choose the workspace palette. Light and dark variants are both available.',
                      children: /* @__PURE__ */ jsx('div', {
                        className: 'w-full',
                        children: /* @__PURE__ */ jsx(WorkspaceThemePicker, {}),
                      }),
                    }),
                  }),
                }),
              activeSection === 'chat' &&
                /* @__PURE__ */ jsx(ChatDisplaySection, {}),
                      ...
                      children: /* @__PURE__ */ jsxs('div', {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxs('span', {
                            ...
                            children: [settings.editorFontSize, 'px'],
                          }),
                        ],
                      }),
                    }),
                ...
                /* @__PURE__ */ jsx(SettingsSection, {
                  ...
                  children: /* @__PURE__ */ jsx(SettingsRow, {
                    ...
                    children: /* @__PURE__ */ jsx('select', {
                      ...
                      children: Object.entries(LOCALE_LABELS).map(
                        ([id, label]) =>
                          /* @__PURE__ */ jsx(
                            'option',
                            { value: id, children: label },
                            id,
                          ),
                      ),
                    }),
                          ...
                          children: /* @__PURE__ */ jsxs('div', {
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ jsxs('span', {
                                className:
                                  'w-12 text-right text-sm tabular-nums text-primary-700',
                                children: [settings.usageThreshold, '%'],
                              }),
                            ],
                          }),
                        }),
                          ...
                          children: /* @__PURE__ */ jsxs('select', {
                            ...
                            children: [
                              ...
                              availableModels.map((model) =>
                                /* @__PURE__ */ jsx(
                                  'option',
                                  { value: model.id, children: model.label },
                                  model.id,
                                ),
                              ),
                            ],
...
function ChatDisplaySection() {
  ...
  return /* @__PURE__ */ jsx(Fragment, {
    children: /* @__PURE__ */ jsxs(SettingsSection, {
      title: 'Chat Display',
...
function HermesConfigSection({ activeView = 'hermes' }) {
  ...
  if (loading) {
    return /* @__PURE__ */ jsx(SettingsSection, {
      title: 'Hermes Agent',
                ...
                children:
                  availableProviders.length > 0
                    ? /* @__PURE__ */ jsx('select', {
                        ...
                        children: availableProviders.map((p) =>
                          /* @__PURE__ */ jsxs(
                            'option',
                            {
                              value: p.id,
                              children: [p.label, p.authenticated ? ' ✓' : ''],
                            },
                            p.id,
                          ),
                        ),
              ...
              /* @__PURE__ */ jsx(
                SettingsRow,
                {
                  ...
                  children: /* @__PURE__ */ jsx('div', {
                    ...
                    children: provider.envKeys.map((envKey) =>
                      /* @__PURE__ */ jsx(
                        'div',
                        {
                          className: 'flex-1',
                            ...
                            /* @__PURE__ */ jsxs('div', {
                              children: [
                                ...
                                /* @__PURE__ */ jsx('p', {
                                  ...
                                  children: String(provider.name || 'Unnamed'),
                                }),
                              ],
                            }),
                            /* @__PURE__ */ jsxs('div', {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx(SettingsRow, {
              ...
              children: /* @__PURE__ */ jsx('span', {
                ...
                children:
                  data.providers.find((p) => p.id === data.activeProvider)
                    ?.name || data.activeProvider,
              }),
            }),
          ],
        }),
    ...
    /* @__PURE__ */ jsxs(SettingsSection, {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(SettingsRow, {
          ...
          children: /* @__PURE__ */ jsxs('select', {
            value: agentConfig.tool_use_enforcement || 'auto',
            onChange: (e) =>
              void saveConfig({
                config: {
                  agent: {
    ...
    /* @__PURE__ */ jsxs(SettingsSection, {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(SettingsRow, {
          ...
          children: /* @__PURE__ */ jsxs('select', {
            value: smartRouting.cheap_model || '',
            onChange: (e) =>
              void saveConfig({
                config: {
                  smart_model_routing: {
            ...
            children: [
              ...
              availableModels.map((model) =>
                /* @__PURE__ */ jsx(
                  'option',
                  { value: model.id, children: model.id },
                  model.id,
                ),
              ),
            ],
          ...
          children: [
            ...
            sttProvider === 'local' &&
              /* @__PURE__ */ jsx(SettingsRow, {
                ...
                children: /* @__PURE__ */ jsx('select', {
                  value: sttLocal.model_size || 'base',
                  onChange: (e) =>
                    void saveConfig({
                      config: {
                        stt: {
    ...
    /* @__PURE__ */ jsxs(SettingsSection, {
      ...
      children: [
        /* @__PURE__ */ jsx(SettingsRow, {
          ...
          children: /* @__PURE__ */ jsx('select', {
            value: displayConfig.personality || 'default',
            onChange: (e) =>
              void saveConfig({
                config: {
                  display: {
            ...
            className: selectClassName,
            children: ['default', 'concise', 'verbose', 'creative'].map(
              (value) =>
                /* @__PURE__ */ jsx(
                  'option',
