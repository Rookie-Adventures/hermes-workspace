...
import 'yaml'
import 'node:util'
function DebugPanel({ analysis, isLoading, onRunCommand, onClose }) {
  return /* @__PURE__ */ jsxs(motion.aside, {
                    ...
                    children: [
                      ...
                      analysis.suggestedCommands.length > 0
                        ? /* @__PURE__ */ jsx('ul', {
                            ...
                            children: analysis.suggestedCommands.map(
...
function TerminalWorkspace({
  ...
  const readerMapRef = useRef(/* @__PURE__ */ new Map())
  ...
  const resizeSession = useCallback(async function resizeSession2(
    tabId,
    terminal,
  ) {
    const currentTab = useTerminalPanelStore
  ...
  const closeTabResources = useCallback(async function closeTabResources2(
    tabId,
    sessionId,
  ) {
