...
import { m as useFeatureAvailable, q as useSettingsStore, s as openHamburgerMenu, v as applyTheme, o as getUnavailableReason, c as cn } from "./router-Cc1BRqzF.js";
      ...
      /* @__PURE__ */ jsx(
        "button",
        {
          ...
          onClick: () => {
            ...
            import("./router-Cc1BRqzF.js").then((n) => n.Q).then(({ setTheme }) => {
