...
function FilesRoute() {
  ...
  const handleInsertReference = useCallback(function handleInsertReference2(
    reference,
  ) {
    setEditorValue(
      (prev) => `${prev}
...
`,
  ...
  return /* @__PURE__ */ jsx('div', {
    ...
    children: /* @__PURE__ */ jsxs('div', {
      ...
      children: [
        /* @__PURE__ */ jsx(FileExplorerSidebar, {
            ...
            /* @__PURE__ */ jsxs('header', {
              ...
              children: [
                /* @__PURE__ */ jsx('button', {
                  ...
                  'aria-label': fileExplorerCollapsed
                    ? 'Show files'
                    : 'Hide files',
...
export { FilesRoute as component }
