...
import { m as useFeatureAvailable, q as useSettingsStore, s as openHamburgerMenu, v as applyTheme, o as getUnavailableReason, c as cn } from "./router-D3Gqb0Hx.js";
      ...
      /* @__PURE__ */ jsx(
        "button",
        {
          ...
          onClick: () => {
            ...
            import("./router-D3Gqb0Hx.js").then((n) => n.Q).then(({ setTheme }) => {
