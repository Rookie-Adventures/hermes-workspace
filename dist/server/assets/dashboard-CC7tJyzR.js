...
import { m as useFeatureAvailable, q as useSettingsStore, s as openHamburgerMenu, v as applyTheme, o as getUnavailableReason, c as cn } from "./router-DZVgeqAb.js";
...
function MetricTile({
  ...
  return /* @__PURE__ */ jsx(GlassCard, { accentColor, children: /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-0.5", children: [
      /* @__PURE__ */ jsx("div", { className: "text-[10px] font-semibold uppercase tracking-[0.15em] text-muted", children: label }),
      /* @__PURE__ */ jsx("div", { className: "text-2xl font-bold tabular-nums text-ink", children: value }),
      sub && /* @__PURE__ */ jsx("div", { className: "text-[11px] text-muted", children: sub })
    ] }),
    /* @__PURE__ */ jsx(
      "div",
      {
...
function ActivityChart({
  ...
  return /* @__PURE__ */ jsxs(
    ...
    {
      title: "Activity",
      titleRight: /* @__PURE__ */ jsx("span", { className: "text-[10px] text-muted", children: "14 days" }),
      accentColor: palette.accent,
      className: "h-full",
      children: [
        /* @__PURE__ */ jsx("div", { className: "h-[200px] w-full -ml-2", children: /* @__PURE__ */ jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxs(
          AreaChart,
          {
            data: chartData,
            ...
            children: [
              /* @__PURE__ */ jsxs("defs", { children: [
                /* @__PURE__ */ jsxs("linearGradient", { id: "g-sessions", x1: "0", y1: "0", x2: "0", y2: "1", children: [
                  /* @__PURE__ */ jsx("stop", { offset: "0%", stopColor: palette.accent, stopOpacity: 0.3 }),
                  /* @__PURE__ */ jsx("stop", { offset: "100%", stopColor: palette.accent, stopOpacity: 0 })
                ] }),
                /* @__PURE__ */ jsxs("linearGradient", { id: "g-messages", x1: "0", y1: "0", x2: "0", y2: "1", children: [
                  /* @__PURE__ */ jsx("stop", { offset: "0%", stopColor: palette.success, stopOpacity: 0.2 }),
                  /* @__PURE__ */ jsx("stop", { offset: "100%", stopColor: palette.success, stopOpacity: 0 })
                ] })
              ] }),
              /* @__PURE__ */ jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: palette.border, opacity: 0.45 }),
              /* @__PURE__ */ jsx(
                XAxis,
                {
                  dataKey: "date",
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-2 flex items-center gap-5 text-[10px] text-muted", children: [
          /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsx("span", { className: "size-2 rounded-full", style: { background: palette.accent } }),
            "Sessions"
          ] }),
          /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsx("span", { className: "size-2 rounded-full", style: { background: palette.success } }),
            "Messages"
          ] })
        ] })
      ]
  ...
  return /* @__PURE__ */ jsx(
    GlassCard,
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 rounded-lg p-2.5 bg-[var(--theme-card2)] border border-[var(--theme-border)]", children: [
          /* @__PURE__ */ jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
            /* @__PURE__ */ jsx("div", { className: "font-mono text-[13px] font-bold text-ink truncate", children: typeof modelName === "string" ? modelName : "—" }),
            /* @__PURE__ */ jsxs("div", { className: "text-[10px] text-muted font-mono truncate", children: [
              provider,
              baseUrl ? ` · ${baseUrl}` : ""
            ] })
          ] })
        ] }),
        fallbackModel && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 rounded-lg p-2.5 bg-[var(--theme-card2)] border border-[var(--theme-border)]", children: [
          /* @__PURE__ */ jsx("div", { className: "flex size-7 items-center justify-center rounded-md bg-amber-500/10 text-sm", children: "🔄" }),
          /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1", children: [
            /* @__PURE__ */ jsx("div", { className: "font-mono text-[13px] text-ink truncate", children: fallbackModel }),
            /* @__PURE__ */ jsx("div", { className: "text-[10px] text-muted font-mono truncate", children: fallbackBlock?.provider ?? "" })
          ] })
        ] })
      ] })
    }
...
function SkillsWidget({ palette }) {
  ...
  return /* @__PURE__ */ jsx(
    ...
    {
      title: "Skills",
      titleRight: /* @__PURE__ */ jsxs("span", { className: "text-[10px] text-muted", children: [
        skills.length,
        " installed"
      ] }),
      accentColor: palette.warning,
      children: skills.length === 0 ? /* @__PURE__ */ jsx("div", { className: "text-xs text-neutral-400 py-4 text-center", children: "No skills installed" }) : /* @__PURE__ */ jsx("div", { className: "space-y-1.5", children: skills.slice(0, 6).map((skill, i) => /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-xs font-medium text-ink truncate flex-1", children: String(skill.name ?? "Unnamed") }),
            skill.enabled !== false && /* @__PURE__ */ jsx("span", { className: "size-1.5 rounded-full bg-emerald-500/60" })
          ]
        },
        String(skill.name ?? i)
      )) })
  ...
  return /* @__PURE__ */ jsxs(
    "button",
    {
      ...
      className: cn(
        ...
        disabled ? "cursor-not-allowed opacity-60" : "hover:border-[var(--theme-accent-border)] hover:scale-[1.01] active:scale-[0.99]"
      ),
      children: [
        /* @__PURE__ */ jsx(
          "div",
        ...
        badge ? /* @__PURE__ */ jsx("span", { className: "ml-auto shrink-0 rounded-full border border-amber-300 bg-amber-100 px-1.5 py-0.5 text-[9px] font-semibold uppercase tracking-[0.12em] text-amber-700", children: badge }) : null,
        /* @__PURE__ */ jsx(
          "div",
          {
    ...
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
          /* @__PURE__ */ jsx("span", { className: "text-[13px] font-medium text-ink truncate flex-1 group-hover:text-ink", children: session.title || session.id }),
          /* @__PURE__ */ jsx("span", { className: "text-[10px] tabular-nums text-muted shrink-0", children: session.started_at ? timeAgo(session.started_at) : "" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "mb-1.5 flex items-center gap-2 text-[10px] text-neutral-500", children: [
          session.model && /* @__PURE__ */ jsx(
            "span",
            {
          ...
          tools > 0 && /* @__PURE__ */ jsxs("span", { children: [
            tools,
            " tools"
          ] }),
          tokens > 0 && /* @__PURE__ */ jsxs("span", { children: [
            formatNumber(tokens),
            " tok"
          ] })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "h-[3px] rounded-full w-full bg-[var(--theme-border)] overflow-hidden", children: /* @__PURE__ */ jsx(
          "div",
          {
...
function DashboardScreen() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-full", children: [
      ...
      /* @__PURE__ */ jsx(
        "button",
        {
          ...
          onClick: () => {
            ...
            import("./router-DZVgeqAb.js").then((n) => n.Q).then(({ setTheme }) => {
    ...
    /* @__PURE__ */ jsxs("div", { className: "px-4 pt-14 md:pt-4 py-4 md:px-8 md:py-6 lg:px-10 space-y-5 pb-28", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-3 py-3", children: [
        /* @__PURE__ */ jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsx("p", { className: "micro-label", style: { color: "var(--theme-muted)" }, children: "Hermes Workspace" }),
        /* @__PURE__ */ jsxs("div", { className: "mt-1 grid w-full max-w-2xl grid-cols-2 gap-2 sm:grid-cols-4", children: [
          /* @__PURE__ */ jsx(
            QuickAction,
            {
              label: "New Chat",
      ...
      sessionsAvailable ? /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-3", children: [
        /* @__PURE__ */ jsx(
          MetricTile,
          {
            label: "Sessions",
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-3", children: [
        /* @__PURE__ */ jsx("div", { className: "lg:col-span-5", children: sessionsAvailable ? /* @__PURE__ */ jsx(ActivityChart, { sessions, palette }) : /* @__PURE__ */ jsx(
          UnavailableWidget,
          {
            title: "Activity",
            description: getUnavailableReason("sessions")
        ...
        /* @__PURE__ */ jsx("div", { className: "lg:col-span-4", children: /* @__PURE__ */ jsx(ModelCard, { palette }) }),
        /* @__PURE__ */ jsx("div", { className: "lg:col-span-3", children: /* @__PURE__ */ jsx(SkillsWidget, { palette }) })
      ] }),
      sessionsAvailable ? /* @__PURE__ */ jsx(
        GlassCard,
        {
          title: "Recent Sessions",
          titleRight: /* @__PURE__ */ jsx(
            "button",
            {
              type: "button",
          ...
          accentColor: palette.accent,
          noPadding: true,
          children: /* @__PURE__ */ jsx("div", { className: "py-1", children: recentSessions.length === 0 ? /* @__PURE__ */ jsx("div", { className: "text-xs text-neutral-400 py-8 text-center", children: "No sessions yet — start a chat!" }) : recentSessions.map((s) => /* @__PURE__ */ jsx(
            SessionRow,
            {
              session: s,
              maxTokens,
