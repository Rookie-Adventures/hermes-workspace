import { ah as Ce } from './main-r209hwEK.js'
function be(se, le) {
  for (var ee = 0; ee < le.length; ee++) {
    const J = le[ee]
    if (typeof J != 'string' && !Array.isArray(J)) {
      for (const V in J)
        if (V !== 'default' && !(V in se)) {
          const te = Object.getOwnPropertyDescriptor(J, V)
          te &&
            Object.defineProperty(
              se,
              V,
              te.get ? te : { enumerable: !0, get: () => J[V] },
            )
        }
    }
  }
                          ...
                          for (var b = i.length - 1; b >= 0; b--)
                            (m = i[b]) &&
                              (g =
                                ...
                                g)
                        return (h > 3 && g && Object.defineProperty(o, l, g), g)
                      },
                    _ =
                      (this && this.__param) ||
                      function (i, o) {
                            ...
                            this._renderService.onRenderedViewportChange(
                              (t) => {
                                ...
                                const i =
                                  ...
                                  o =
                                    this._bufferService.buffer.ydisp + 1 + t.end
                                if (
...
WARNING: This link could potentially be dangerous`)
                  ...
                  class W extends y.CoreTerminal {
                    ...
                    _syncTextArea() {
                      ...
                      const B = Math.min(this.buffer.x, this.cols - 1),
                        ...
                        q = B * this._renderService.dimensions.css.cell.width
                      ...
                      function B(F) {
                        ...
                        switch (F.overrideType || F.type) {
                          case 'mousemove':
                            ...
                            break
                          case 'mouseup':
                            ;((G = 0), (q = F.button < 3 ? F.button : 3))
                            break
                          case 'mousedown':
                            ;((G = 1), (q = F.button < 3 ? F.button : 3))
                            break
                          case 'wheel':
                            if (S.viewport.getLinesScrolled(F) === 0) return !1
                            ;((G = F.deltaY < 0 ? 0 : 1), (q = 4))
                            break
                          default:
                            return !1
                        }
                        return (
                          !(G === void 0 || q === void 0 || q > 4) &&
                          ...
                          for (var L = o.length - 1; L >= 0; L--)
                            (h = o[L]) &&
                              (b =
                                ...
                                b)
                        return (g > 3 && b && Object.defineProperty(l, v, b), b)
                      },
                    _ =
                      (this && this.__param) ||
                      function (o, l) {
                          ...
                          for (var w = y.length - 1; w >= 0; w--)
                            (O = y[w]) &&
                              (C =
                                ...
                                C)
                        return (M > 3 && C && Object.defineProperty(k, x, C), C)
                      },
                    _ =
                      (this && this.__param) ||
                      function (y, k) {
                  ...
                  let o = (r.DomRendererRowFactory = class {
                    ...
                    createRow(v, m, h, g, b, L, y, k, x, T, O) {
                      ...
                      for (let j = 0; j < D; j++) {
                        ...
                        const re = this._isCellInSelection(j, m),
                          ce = h && j === L,
                          de = F && j >= T && j <= O
                        let ue = !1
                        ...
                        let he = $.getChars() || d.WHITESPACE_CELL_CHAR
                        if (
                          (he === ' ' &&
                            ($.isUnderline() || $.isOverline()) &&
                            (he = ' '),
                          (A = q * k - x.get(he, $.isBold(), $.isItalic())),
                          E)
                        ) {
                          if (
                            P &&
                            ((re && B) || (!re && !B && $.bg === U)) &&
                            ((re && B && w.selectionForeground) ||
                              $.fg === W) &&
                            $.extended.ext === z &&
                            de === S &&
                            A === R &&
                        ...
                        if (
                          ...
                          (B = re),
                          G && L >= j && L <= ie && (L = j),
                          !this._coreService.isCursorHidden && ce)
                        ) {
                          if (
                            (N.push('xterm-cursor'),
                        ...
                        ;($.isOverline() &&
                          ...
                          de && (E.style.textDecoration = 'underline'))
                        let X = $.getFgColor(),
                          ne = $.getFgColorMode(),
                          Y = $.getBgColor(),
                          oe = $.getBgColorMode()
                        ...
                        switch (
                          (this._decorationService.forEachDecorationAtCell(
                            ...
                            void 0,
                            (K) => {
                              ;(K.options.layer !== 'top' && ae) ||
                                (K.backgroundColorRGB &&
                                  ((oe = 50331648),
                                  (Y =
                                    (K.backgroundColorRGB.rgba >> 8) &
                                    16777215),
                                  (Z = K.backgroundColorRGB)),
                                K.foregroundColorRGB &&
                                  ((ne = 50331648),
                                  (X =
                                    (K.foregroundColorRGB.rgba >> 8) &
                                    16777215),
                                  (fe = K.foregroundColorRGB)),
                                (ae = K.options.layer === 'top'))
                            },
                          ),
                          !ae &&
                            re &&
                            ((Z = this._coreBrowserService.isFocused
                            ...
                            w.selectionForeground &&
                              ...
                              (fe = w.selectionForeground))),
                          ae && N.push('xterm-decoration-top'),
                          oe)
                        ) {
                          case 16777216:
                          case 33554432:
                            ;((Q = w.ansi[Y]), N.push(`xterm-bg-${Y}`))
                            break
                          case 50331648:
                            ;((Q = u.rgba.toColor(
                              Y >> 16,
                        ...
                        switch (
                          (Z ||
                            ($.isDim() &&
                              (Z = u.color.multiplyOpacity(Q, 0.5))),
                          ne)
                        ) {
                          case 16777216:
                          case 33554432:
                          ...
                          case 50331648:
                            ...
                            this._applyMinimumContrast(E, Q, K, $, Z, fe) ||
                              this._addStyle(
                                E,
                ...
                2223: (I, r, a) => {
                  ...
                  ;((r.INVERTED_DEFAULT_COLOR = 257),
                    (r.DIM_OPACITY = 0.5),
                    (r.TEXT_BASELINE =
                      c.isFirefox || c.isLegacyEdge ? 'bottom' : 'ideographic'))
                },
                6171: (I, r) => {
                  function a(c) {
                          ...
                          for (var T = h.length - 1; T >= 0; T--)
                            (y = h[T]) &&
                              (x =
                                ...
                                x)
                        return (k > 3 && x && Object.defineProperty(g, b, x), x)
                      },
                    _ =
                      (this && this.__param) ||
                      function (h, g) {
                      ...
                      if (this._activeSelectionMode === 3) {
                        ...
                        if (h[1] !== g[1]) {
                          const k = b.lines.get(g[1]),
                            x = b.translateBufferLineToString(g[1], !0, 0, g[0])
                          ...
                          for (var x = m.length - 1; x >= 0; x--)
                            (L = m[x]) &&
                              (k =
                                ...
                                k)
                        return (y > 3 && k && Object.defineProperty(h, g, k), k)
                      },
                    _ =
                      (this && this.__param) ||
                      function (m, h) {
                    ...
                    (function (l) {
                      ...
                      ;((l.ensureContrastRatio = function (h, g, b) {
                        ...
                        if (o(L, y) < b) {
                          ...
                          if (x < b) {
                            const T = v(h, g, b)
                            return x > o(L, s.relativeLuminance(T >> 8)) ? k : T
                          }
                          return k
                        }
                      }),
                          ...
                          for (var U = M.length - 1; U >= 0; U--)
                            (D = M[U]) &&
                              (H =
                                ...
                                H)
                        return (P > 3 && H && Object.defineProperty(C, w, H), H)
                      },
                    _ =
                      (this && this.__param) ||
                      function (M, C) {
                  ...
                  class p {
                    ...
                    insertCells(e, s, t, i) {
                      if (
                        ...
                        for (let o = e; o < this.length; ++o) this.setCell(o, t)
...
`),
                  ...
                  class c {
                    static fromArray(n) {
                      ...
                      for (
                        ...
                        const p = n[f]
                        if (Array.isArray(p))
                          for (let u = 0; u < p.length; ++u) d.addSubParam(p[u])
                        else d.addParam(p)
                      }
                      return d
                    }
                  ...
                  ;((r.LogService = u = c([_(0, d.IOptionsService)], u)),
                    ...
                    (r.traceCall = function (e, s, t) {
                      ...
                      t.value = function (...o) {
                        ...
                        return (p.trace(`GlyphRenderer#${i.name} return`, l), l)
                      }
                    }))
                },
                7302: (I, r, a) => {
                ...
                2585: (I, r, a) => {
                  ...
                  const c = a(8343)
                  var _
                  ;((r.IBufferService = (0, c.createDecorator)(
                    'BufferService',
                  )),
            ...
            function V(I) {
              ...
              var a = (J[I] = { exports: {} })
              return (ee[I].call(a.exports, a, a.exports, V), a.exports)
            }
            var te = {}
            return (
              (() => {
...
var me = ye()
const we = Ce(me),
  ke = be({ __proto__: null, default: we }, [me])
export { ke as x }
