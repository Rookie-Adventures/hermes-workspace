...
function KnowledgeBrowserScreen() {
  ...
  useEffect(() => {
    ...
    if (selectedPath && pages.some((page2) => page2.path === selectedPath))
      return
  ...
  const searchQuery = useQuery({
    ...
    queryFn: () =>
      readJson(`/api/knowledge/search?q=${encodeURIComponent(searchTerm)}`),
            ...
            /* @__PURE__ */ jsxs('aside', {
              ...
              children: [
                ...
                !knowledgeExists && !listQuery.isLoading
                  ? /* @__PURE__ */ jsx('div', {
                      className: 'px-3 pb-3',
                      children: /* @__PURE__ */ jsx(EmptyKnowledgeState, {
                        knowledgeRoot,
                      }),
                    })
                  : searchTerm
                    ? /* @__PURE__ */ jsxs('div', {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsx('div', {
                            className: 'space-y-1',
                            children: searchQuery.isLoading
                              ? /* @__PURE__ */ jsx(StateBox, {
                        ...
                        children: /* @__PURE__ */ jsxs('div', {
                          ...
                          children: [
                            ...
                            /* @__PURE__ */ jsx('section', {
                              ...
                              children: listQuery.isLoading
                                ? /* @__PURE__ */ jsx(StateBox, {
                                    label: 'Loading knowledge pages...',
                                  })
                                : listQuery.error instanceof Error
                                  ? /* @__PURE__ */ jsx(StateBox, {
                                      label: listQuery.error.message,
                                      error: true,
                                    })
                ...
                /* @__PURE__ */ jsx('div', {
                  ...
                  children: listQuery.isLoading
                    ...
                    : listQuery.error instanceof Error
                      ...
                      : !knowledgeExists
                        ? /* @__PURE__ */ jsx(EmptyKnowledgeState, {
                            knowledgeRoot,
                          })
                        : !selectedPath
                          ? /* @__PURE__ */ jsx(StateBox, {
        ...
        /* @__PURE__ */ jsx(DialogRoot, {
          ...
          children: /* @__PURE__ */ jsxs(DialogContent, {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx('div', {
                className: 'p-5',
                children: graphQuery.isLoading
                  ? /* @__PURE__ */ jsx(StateBox, { label: 'Loading graph...' })
                  : graphQuery.error instanceof Error
                    ? /* @__PURE__ */ jsx(StateBox, {
                        label: graphQuery.error.message,
                        error: true,
                      })
                    : (graphQuery.data?.nodes?.length ?? 0) === 0
                      ? /* @__PURE__ */ jsx(StateBox, {
                          label: 'No graph data yet',
                        })
                      : /* @__PURE__ */ jsx(GraphCanvas, {
...
function TreeSection({ node, selectedPath, onSelectPath, depth = 0 }) {
  return /* @__PURE__ */ jsxs('div', {
    className: cn('space-y-1', depth > 0 && 'mt-1'),
    children: [
      node.path
        ? /* @__PURE__ */ jsxs('div', {
            className:
...
function TagPill({ label, count, active, onClick }) {
