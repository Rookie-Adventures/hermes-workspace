...
import { m as useFeatureAvailable, q as useSettingsStore, s as openHamburgerMenu, v as applyTheme, o as getUnavailableReason, c as cn } from "./router-DptZWST5.js";
      ...
      /* @__PURE__ */ jsx(
        "button",
        {
          ...
          onClick: () => {
            ...
            import("./router-DptZWST5.js").then((n) => n.Q).then(({ setTheme }) => {
