...
import { m as useFeatureAvailable, q as useSettingsStore, s as openHamburgerMenu, v as applyTheme, o as getUnavailableReason, c as cn } from "./router-COrtOO2b.js";
      ...
      /* @__PURE__ */ jsx(
        "button",
        {
          ...
          onClick: () => {
            ...
            import("./router-COrtOO2b.js").then((n) => n.Q).then(({ setTheme }) => {
