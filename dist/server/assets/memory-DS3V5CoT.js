...
import { m as useFeatureAvailable, T as Tabs, f as TabsList, g as TabsTab, h as TabsPanel, n as BackendUnavailableState, o as getUnavailableReason } from "./router-D3Gqb0Hx.js";
...
const MemoryBrowserScreen = lazy(async () => {
  const module = await import("./memory-browser-screen-CqRokz1e.js");
  return {
    default: module.MemoryBrowserScreen
  };
});
const KnowledgeBrowserScreen = lazy(async () => {
  const module = await import("./knowledge-browser-screen-C2ngg_Ej.js");
  return {
