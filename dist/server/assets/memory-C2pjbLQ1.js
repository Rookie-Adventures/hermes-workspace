...
import { m as useFeatureAvailable, T as Tabs, f as TabsList, g as TabsTab, h as TabsPanel, n as BackendUnavailableState, o as getUnavailableReason } from "./router-DptZWST5.js";
...
const MemoryBrowserScreen = lazy(async () => {
  const module = await import("./memory-browser-screen-C07LR8v-.js");
  return {
    default: module.MemoryBrowserScreen
  };
});
const KnowledgeBrowserScreen = lazy(async () => {
  const module = await import("./knowledge-browser-screen-ClIGju7w.js");
  return {
